        ...
        <div class="col-sm-6 col-md-3">
            <div class="thumbnail" style="height: 500px">
                <a href="<c:url value='/products/product?id=${product.id}' />">
                    <img src="/resources/img/product.jpg" alt="image" style="width:100%; height:200px"/>
                </a>
                ...
                <div class="price and button" style="height: 80px">
                    ...
                    <div class="pull-right" ng-controller="cartCtrl">
                        <a href="#" class="btn btn-danger btn-sm" role="button" ng-click="addToCart('${product.id}')">Добавить в корзину</a>
                    </div>
                </div>
            </div>
        </div>
